...
- (void)setupTitleLabel:(NSString *)titleStr{
    ...
    self.titleLabel.frame = CGRectMake(0, contentHeight + subViweMargin+self.titleLabelTopMargin, width, fontSize);
...
- (void)setupDetailLabel:(NSString *)detailStr{
    ...
    self.detailLabel.frame = CGRectMake(0, contentHeight + subViweMargin+self.detailLabelTopMargin, width, height);
