...
/**
 titleLabel 跟图片的间隔 默认0
 */
@property (nonatomic, assign) CGFloat  titleLabelTopMargin;

/**
 detailLabel 跟titleLabel的间隔 默认0
 */
@property (nonatomic, assign) CGFloat  detailLabelTopMargin;
